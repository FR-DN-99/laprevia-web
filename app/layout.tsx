...
export const metadata: Metadata = {
  ...
  description:
    'La Previa Group organiza los mejores eventos de música electrónica en Tenerife, incluyendo fiestas de Drum and Bass y Techno con artistas locales e internacionales. Discover unique electronic music experiences in Tenerife, from Drum and Bass to Techno parties.',
  keywords:
